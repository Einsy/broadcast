...
* @Last Modified time: 2015-06-08 10:29:09
*/
(function(root, factory){
	 ...
	 * @author huzc
	 * @date   2015-06-06
	 * @param  {[type]}   eventType [广播频道]
	 * @param  {[type]}   handler   [收到的广播数据]
	 * @return {[type]}             [无]
	 */
	 ...
	 * @author huzc
	 * @date   2015-06-06
	 * @param  {[type]}   eventType [发送广播频道]
	 * @param  {[type]}   data      [发送广播数据]
	 * @return {[type]}             [无]
	 */
	 ...
	 * @author huzc
	 * @date   2015-06-06
	 * @param  {[type]}   win [window对象，需要需要的页面window对象]
	 * @return {[type]}       [description]
	 */
	 ...
	 * @author huzc
	 * @date   2015-06-06
	 * @param  {[type]}   win       [窗口window对象]
	 * @param  {[type]}   eventType [广播频道]
	 * @param  {[type]}   data      [广播数据]
	 * @return {[type]}             [无]
	 */
